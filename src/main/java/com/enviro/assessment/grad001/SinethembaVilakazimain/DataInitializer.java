...
public class DataInitializer implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        WasteCategory paperCategory = new WasteCategory(null, "Paper Waste", true, "Recyclable");
    ...
    private void createDisposalGuidelines(WasteCategory wasteCategory, String disposalMethod,boolean hazardous) {
        DisposalGuidelines guidelines = new DisposalGuidelines(null, wasteCategory, wasteCategory.getCategoryName(), hazardous, disposalMethod);
